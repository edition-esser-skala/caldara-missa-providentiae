...
DomineDeusAgnusAltoNotes = {
	\relative c' {
		...
		d2.
		R2.*15 %434
		R2.\fermataMarkup \bar "||" %435 finis
	}
}
...
BenedictusAltoNotes = {
	\relative c' {
		...
		R1*13 %49
		r4 \mvTr c8\pE^\soloE c d([ e)] f g %50
		e c f2 es4~
		es8 es d4 c4( f8.) f16
		e2 e4. e8
		f4 f r f
		...
		f2 r
		R1*11 %102
		R1\fermataMarkup \bar "||" %103 finis
	}
}
...
OsannaAltoNotes = {
	\relative c' {
		...
		d2 b'2. a4 g2~
		g f e1-\critnote %135
		fis\breve\fermata \bar "|." %136 FINIS
	}
}
...
AgnusDeiAltoNotes = {
	\relative c' {
		...
		e4) c c2
		c1\fermata \bar "||"
		\tempoAgnusDeiII f8 f f f16 f e4 e8 e %40
		d4 d d2
