...
GratiasSopranoNotes = {
	\relative c' {
		...
		a1.
		R1.*10 %241
		R1.\fermataMarkup \bar "||" %242 finis
	}
}
...
DomineFiliSopranoNotes = {
	\relative c' {
		...
		g r %320
		R1*3
		R1\fermataMarkup \bar "||" %324 finis
	}
}
...
CrucifixusSopranoNotes = {
	\relative c' {
		...
		\tempoSepultus r4 a a4. a8
		g2 r
		R1
		R\fermataMarkup \bar "||" %144 finis
	}
}
...
EtResurrexitSopranoNotes = {
	\relative c' {
		...
		d2 r
		R1*2 %171
		R1\fermataMarkup \bar "||" %172 finis
	}
}
...
OsannaSopranoNotes = {
	\relative c' {
		...
		d c
		d2 c4 c h2. h4
		a2^\critnote a a4( g) f2~
		f d'4 d d( c) b2
		a a a1 %135
		a\breve\fermata \bar "|." %136 FINIS
	}
}
...
AgnusDeiSopranoNotes = {
	\relative c' {
		...
		g([ c,)] f2( e4)
		f1\fermata \bar "||"
		\tempoAgnusDeiII a8 a a a16 a a4 a8 a %40
		a4 g8[( f]) g2
