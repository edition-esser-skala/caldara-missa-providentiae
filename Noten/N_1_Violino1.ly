...
GratiasViolinoI = {
	\relative c' {
		...
		r4 \mvTr e'\fE-\markup { \anmerkung "senza Oboi" } e e e e
		e, e' e, d' c h
		c e cis g' f e
		f d g, f' e d %175
		e c a e' d c
...
QuoniamViolinoI = {
	\relative c' {
		...
		\mvTr f'16\fE-\vvE c a c f c a c f4 r8 a,
...
CredoViolinoI = {
	\relative c' {
		...
		R\fermataMarkup %80
		R2.*3
		r8 a'-\markup { \anmerkung "piano un poco" } a g f e
		f4 fis4. e16 fis %85
		g,8 g' g f es d
		es4 e4. d16 e
		f,8 f' f es d c
...
BenedictusViolinoI = {
	\relative c' {
		...
		a4 a'8 g f es d c
		b2~ b8 a g f
		e g' f e f, f' es d %100
		es,? es'? d c d, d' c b
		c, c' b a g2
		f4\fermata r r2 \bar "||" %103 finis
	}
}
