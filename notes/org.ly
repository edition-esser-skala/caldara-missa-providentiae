...
KyrieIOrgano = {
  \relative c {
    ...
    c, d e c f g a f
    b a b g c c d a
    b g c c, f\fE g a f %30
    c d e c g' a b g
    d e f d a' h c! a
    e e c a d e f d
    a' h c a d h e e,
    a\pE a, c a e' fis gis e %35
    a, h c a d e f d
    g, a h g c d e c
    f, f' a h c c, e c
    d e f g a h c a
    d, h e e, a\fE h cis a %40
    d-\tuttiE e f d a h cis a
    d e f d g a b g
    c, d e c g a b g
    d' c d d, g g h g
...
KyrieIBassFigures = \figuremode {
  ...
  <_+>2 \bc <[_!]>
  r1
  r2 \bo <9 7 [_-]>4 \bassFigureExtendersOn <8 [6-] _->8 \bc <7 5 [_-]> %60
  <[6!] 4+ 2>4 <7 _!> <4> <_+>
  <_!> <6> <7> <6>
  <5 _+>1 %63 finis
}
...
KyrieIIBassFigures = \figuremode {
  ...
  <[6]> <3> <2> \bo <[6]>
  <_+>1 <6>2 \bc <[_-]>
  <9- _+>2 \bassFigureExtendersOn <8 _+>4 <7 _+> \bassFigureExtendersOff r1 %170
  <4>2 <_+> r1
  <5> <9 _+>2 <8 \t>
  <_!>1 <5 4>2 <\t _+>
  <_+>1 <9 _!>2 <8 6->
  ...
  <_+>1 <6>
  <4 2+>2 \bo <[_+]> \bc <[6]> <6->
  <9- _+> \bassFigureExtendersOn <8 _+>4 <7 _+> \bassFigureExtendersOff r1 %195
  <6 5 [_-]>2 <[_!]> <6 5> <_->
  <9- _+> \bassFigureExtendersOn <8 _+>4 <7 _+> \bassFigureExtendersOff <9>2 <8>
  <7> <6> <5> <6>
  <7 [_-]> <6> <5 _+> <6 4>
  <5 4> \bassFigureExtendersOn <5 _+>4 <5 2> <5 _+>1 \bassFigureExtendersOff %200
  <[_+]>\breve %201 FINIS
}
...
GratiasBassFigures = \figuremode {
  ...
  r2 <_+>1
  r1 <[_+]>2
  \bo <[6]> \bc q4 <7 _+> <5>2 %185
  r1 <6>2
  r1.
  r2. <7>
  r1 <6\\>2
  \bo <[5+] _+> \bc <[6]>2. <[6 _+]>4 %190
  r2 <6>4 <[6\\]> <6> <6\\>
  r q \bo <[5+] 4>2 \bc <[\t] _+>
  r2 <[6]>1
  <6>2. <6\\>4 r <[6]>
  ...
  <6>2. <6\\>4 r \bc <[6]>
  r1.
  <6->1 \bassFigureExtendersOn q4 \bassFigureExtendersOff <[6]>
  \bo <[5!] _+>1 <6>4 <6\\>
  \bc <[6]>2 <4> <_+> %230
  r1.
  <[6]>2. <7 [_+]>4 <5> <6>
...
DomineDeusRexBassFigures = \figuremode {
  ...
  <6->2 <5> <6\\>1
  \bo <[6]>2 \bc <[_+]> <9> <8> %255
  \bo <[5 3]>2 <6 4>4 <8 6> <_->2 <8 6>4 \bc <[\t \t]>
  <6 4>1 <5 3>
  r2 <[6]> <6>1
  <6->2 <3> <2> <6>
  r1 <5>2 <6> %260
...
QuiTollisBassFigures = \figuremode {
  ...
  <5+ 4> <\t _+> <9+> <8> %440
  <6 5>2 <6 5 [_+]>
  <[9+]>4 <8>8 <[7+]> <8>4 \bo <[6]>8 \bc <[6\\]>
  <7 [5+] _+>4 <6 4> \bo <[5+] 4> \bc <[\t] _+>
  r2 <6! 5>4 <5>
  <5 4> <\l 3> <9> <[6]> %445
  <2> <6> <7 _+> <6 4>
  <5 4> <\t _+> <7 _+> <6 4>
...
QuoniamBassFigures = \figuremode {
  ...
  r2 <_!>8 <6> \bc <[7 \l]> r
  r2 <6>4 <5->
  \bo <[4-]>8 \bc <[3]> r4 <6> \bassFigureExtendersOn q8 \bassFigureExtendersOff <7 _!>
  <4> <3> r2.
  <5 4>4 <\l 3> <9> <8> %490
  <5 4> <\t 3> <6 5> <\t \t>
  r <5> r \bo <[6 4]>8 \bc <[5 3]>
  r1
  r4 \bo <[6]> r <6>
  r \bc <[6]> <7> <6> %495
  r2. <[6]>4
  ...
  r2 <_!>8 <6> \bc <[7 \l]> r
  r2 <6>4 <5-> %540
  <4->8 <3> r4 \bo <[6 \l]>4. <7 _!>8
  <4> \bc <[3 \l]> r2.
  <5 4>4 <\t 3> <9> <8>
  <5 4> <\t 3> <6 5> <\t \t>
  r <5> r \bo <[6] 4>8 \bc <[5] 3> %545
  r1 %546 finis
}
...
CumSanctoOrgano = {
  \relative c {
    ...
    b1
    a\fermata \bar "||"
    \tempoCumSanctoFuga \clef treble d'2 a'4 f~ %550
    f e2 d4~
    d cis d d
    << {
      a'2 d4 c~
...
AgnusDeiOrgano = {
  \relative c {
    ...
    c
    f\fermata \bar "||"
    \tempoAgnusDeiII d4.\pp d8 a'4 a %40
    b1
...
DonaNobisBassFigures = \figuremode {
  ...
  <6> <3> <2> <6>
  <_+>1 <6>2 <_->
  <9- _+>2 \bassFigureExtendersOn <8 _+>4 <7 _+> \bassFigureExtendersOff r1
  <4>2 <_+> r1 %50
  <5> <9 _+>2 <8 \t>
  <_!>1 <5 4>2 <\t _+>
  <_+>1 <9 _!>2 <8 6->
  ...
  <_+>1 <6>
  <4 2+>2 <_+> <6> <6->
  <9- _+> \bassFigureExtendersOn <8 _+>4 <7 _+> \bassFigureExtendersOff r1
  <6 5 _->2 <_!> <6 5> <_-> %75
  <9- _+> \bassFigureExtendersOn <8 _+>4 <7 _+> \bassFigureExtendersOff <9>2 <8>
  <7> <6> <5> <6>
  <7 _-> <6> <5 _+> <6 4>
