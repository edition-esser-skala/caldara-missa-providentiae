...
\paper {
	...
	first-page-number = #1 % K: 1   G: 13   C: 59   S: 81   A: 91
	print-first-page-number = ##t
}
...
tempoKyrieII = \tempoMarkup "Adagio"
  tempoKyrieIIFuga = \tempoMarkup "[Tempo deest]"
...
tempoCrucifixus = \tempoMarkup "Adagio a 4"
	tempoSepultus = \tempoMarkup "Adagio pianissime"
...
tempoAgnusDei = \tempoMarkup "Adagio"
	tempoAgnusDeiII = \tempoMarkup "Adagissimo piano"
...
\layout {
	...
	\context {
		\Score
		skipBars = ##t % a global \compressFullBarRests
